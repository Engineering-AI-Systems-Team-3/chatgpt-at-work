...
## Core Principles
Does this specific conversation — given its content, framing, and the nature of what is being produced — appear to be 
part of someone's actual job, business activity, organizational responsibility, or client-facing work?
...
- (2) Clearly Work-Related: 
    - The conversation contains direct evidence that the user is carrying out a task for an employer, client, business,
    organization, profession, or occupational responsibility.
    - The user is producing, modifying, or analyzing a real work deliverable.
    - The conversation references workplace stakeholders, customers, projects, contracts, operations, reporting, 
    compliance, business processes, or professional responsibilities.
...
- Label 2 only if a reasonable reader would infer that the user is currently performing work for an employer, client, 
business, organization, or professional practice. If that inference is not clearly supported by the conversation, do not
use 2.
